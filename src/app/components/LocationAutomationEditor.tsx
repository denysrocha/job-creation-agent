...
interface LocationAutomationEditorProps {
  config: any;
  onChange: (config: any) => void;
}

export function LocationAutomationEditor({ config, onChange }: LocationAutomationEditorProps) {
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="relative">
          <input
            type="text"
            value={config.nome || 'Reprova por modelo híbrido/presencial'}
      ...
      <div>
        ...
        <div>
          ...
          <select
            value={config.gatilho || 'Talento sinalizou indisponibilidade para modelo da vaga'}
          ...
          >
            <option value="Talento sinalizou indisponibilidade para modelo da vaga">Talento sinalizou indisponibilidade para modelo da vaga</option>
      ...
      <div>
        ...
        <select
          value={config.motivo || 'localizacao'}
          onChange={(e) => updateConfig('motivo', e.target.value)}
          className="w-full px-3 py-2.5 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent bg-white"
        >
          <option value="">Selecione um motivo</option>
          <option value="localizacao">Localização/Necessita mudança de local</option>
          <option value="modelo">Modelo de trabalho incompatível</option>
          ...
          {config.emailTab !== 'review' ? (
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  type="text"
                  value={config.assunto || 'Processo seletivo - Informações sobre modelo de trabalho'}
              ...
              <div>
                ...
                <div className="border border-gray-300 rounded-md overflow-hidden">
                  ...
                  <textarea
                    value={config.corpoEmail || 'Olá!\n\nAgradecemos seu interesse em fazer parte da nossa equipe.\n\nApós análise de sua candidatura, identificamos que há incompatibilidade entre sua disponibilidade de localização/modelo de trabalho e as necessidades da posição, que requer presença no formato híbrido/presencial em nossa sede.\n\nInfelizmente, não poderemos dar continuidade ao processo neste momento. Entretanto, manteremos seu currículo em nosso banco de talentos para futuras oportunidades que possam estar mais alinhadas ao seu perfil e preferências de trabalho.\n\nDesejamos sucesso em sua jornada profissional!\n\nAtenciosamente,\nEquipe de Recrutamento'}
